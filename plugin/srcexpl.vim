...
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"                                                                              "
" File_Name__: srcexpl-compat.vim                                              "
...
"              Insight'.                                                       "
"              This version has been modified to not use the preview window.   "
"              This reduces conflicts with plugins that use the preview        "
"              window.                                                         "
" Author_____: Wenlong Che <wenlong.che@gmail.com>                             "
"              Jonathan Lai <laiks.jonathan@gmail.com>                         "
" Version____: 4.3a                                                            "
" Last_Change: April 27, 2011                                                  "
...
function! <SID>SrcExpl_WinromptNoDef()
...
function! <SID>SrcExpl_TagSth(expr)
    ...
    " No tag
        ...
        if s:SrcExpl_status > 0
            call <SID>SrcExpl_WinromptNoDef()
            " No definition
...
function! <SID>SrcExpl_Win()
    ...
    if getwinvar(s:SrcExpl_Window, 'srcexpl') == 1
        return s:SrcExpl_Window
    endif
